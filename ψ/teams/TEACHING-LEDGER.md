...
- 🔴 **`"2 จาก 34"`** — ตัวเลขจริงคือ **4 จาก 37** (และตอน 14:30 ผมรันได้ **41 alias / 9 layer**
  ซึ่งไม่ตรงกับทั้งคู่ เพราะ loom กำลัง rebind อยู่) ⇒ **ยังไม่ fan-out** ·
  **ไม่ทราบผู้ถือ** เพราะไม่เคยลง ledger — สโคปที่ค้น: `grep -rn` ทั่ว `ψ/`
- 🟡 **`model-tier-census.py` ไม่เคยอยู่บน main** — บอก loom + lucifer แล้ว · **holmes ยังไม่ได้บอก**
  ทั้งที่ **holmes คือคนที่เสียเวลาไปทำ census มือเพราะเรื่องนี้** ⇒ ต้องส่ง
